...
# ⚡ Установка и настройка Meshtastic на LilyGO T3-S3 (ESP32-S3)
...
Подключаем наш LilyGO T3-S3 (ESP32-S3) по usb
...
Теперь определим на каком порту определилось устройство
ls /dev/tty*
...
Переходим к сборке прошивки для работы с gpio
...
Открываем  в блокноте или проводнике файл platformio.ini. 
