...
Сделать это можно несколькими способами,а в статье описан один из них, в результате чего появляется возможность управлять включением различных устройств от светодиода до БПЛА.  Решение "нащупано" автором самостоятельтно, хотя на оригинальность, конечно, не претендую. 
